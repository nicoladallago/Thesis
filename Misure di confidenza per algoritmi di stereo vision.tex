...
%%--------------------------- RISULTATI ----------------------------------------------%%
	...
	\pagestyle{fancy}				
		...
		Se come parametro di riferimento \cite{mercedes} si è tenuto $\gamma=480$, ora indagheremo su quali effetti produce la sua variazione.
		
		\begin{figure}[<h>]
			\subfloat[][\emph{Immagine originale.}]
			{\includegraphics[width=.31\textwidth]{./figures/view1.png}} \quad
			\subfloat[][\emph{Ground truth.}]
			{\includegraphics[width=.31\textwidth]{./figures/disp1.png}} \quad
			\subfloat[][\emph{Misura Local Curve.}]
			{\includegraphics[width=.31\textwidth]{./figures/LC.png}}
			
			\caption{Differenza tra \textit{ground truth} e la misura calcolata con \textit{Local Curve.}}
